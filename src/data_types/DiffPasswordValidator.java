...
public class DiffPasswordValidator {
    ...
    public DiffPasswordValidator(String username, String currentPassword){
    ...
    public static DiffPasswordValidator login(){
        ...
        return new DiffPasswordValidator(username, password);
    }
